...
int main(appliances** mass) {
	appliances* mass[3];
	technik Technik(1, "q", 10, 1000, 220, "red");
	technik_info Technik_info(1, "q", 10, 1000, 123, 18);
	technik_dopinfo Technik_dopinfo(1, "q", 10, 1200, "sony", 100);
	mass[0] = &Technik;
	mass[1] = &Technik_info;
	mass[2] = &Technik_dopinfo;
	bool flag = true;
	int choise = 0;
	...
	while (flag == true) {
		...
		case 1: {
			...
			color = writeWords();
			system("cls");
			mass[0] = new technik(serial_number, type, weight, power, voltage, color);
			mass[0]->view();
			break;
		}
		case 2: {
			...
			height = writeNumbers();
			system("cls");
			mass[1] = new technik_info(serial_number, type, weight, power, width, height);
			mass[1]->view();
			break;
		}
		case 3: {
			...
			brand = writeWords();
			system("cls");
			mass[2] = new technik_dopinfo(serial_number, type, weight, power, brand, price);
			mass[2]->view();
			break;
		}
		case 0: {
